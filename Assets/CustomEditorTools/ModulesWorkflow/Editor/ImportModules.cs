...
namespace CustomEditorTools.Modules {
    public class ImportModules
    {
        ...
        public bool OnGUI (Module projectModule) {
            ...
            EditorGUILayout.LabelField("Choose Module", EditorStyles.boldLabel);
            ...
            DoubleLabel("Modules In Project:", "Version:", EditorStyles.boldLabel, GUITools.white);
            for (int i = 0; i < modulesInProject.Count; i++) {
                DoubleLabel(modulesInProject[i].moduleName, "v" + modulesInProject[i].currentVersion, EditorStyles.label, modulesInProject[i] == projectModule ? GUITools.lightBlue : GUITools.white);
            }   
