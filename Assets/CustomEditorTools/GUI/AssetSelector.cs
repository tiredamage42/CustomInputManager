...
namespace CustomEditorTools {
    ...
    */    
    ...
    [CustomPropertyDrawer(typeof(AssetSelectionAttribute))]
    public class AssetSelectionDrawer : PropertyDrawer
    {
    ...
    public class AssetSelector {
        ...
        GUIContent resetButtonContent {
            get {
                if (_resetButtonContent == null) _resetButtonContent = new GUIContent("", "Update Asset References");
        ...
        public void UpdateAssetReferences (bool logToConsole, Func<List<AssetSelectorElement>, List<AssetSelectorElement>> onAssetsLoaded) {
            elements = onAssetsLoaded(BuildElements(logToConsole));
        ...
        public Object Draw (Rect pos, Object current, GUIContent gui, Func<List<AssetSelectorElement>, List<AssetSelectorElement>> onAssetsLoaded) {
            //draw field
            int selected = EditorGUI.Popup (new Rect(pos.x, pos.y, (pos.width - GUITools.littleButtonSize * 4), pos.height), gui.text, GetActiveIndex(current), allNames);
            
            // draw reset button
            if (GUITools.LittleButton(new Rect(pos.x + ((pos.width - GUITools.littleButtonSize * 4)), pos.y, 0, 0), resetButtonContent, GUITools.blueColor)) {
        ...
        public Object Draw (Object current, GUIContent gui, Func<List<AssetSelectorElement>, List<AssetSelectorElement>> onAssetsLoaded) {
            ...
            // draw reset button
            if (GUITools.LittleButton(resetButtonContent, GUITools.blueColor)) {
                UpdateAssetReferences(true, onAssetsLoaded);
            }
